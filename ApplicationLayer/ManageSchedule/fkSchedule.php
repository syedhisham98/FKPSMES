...
<!-- CONTENT -->
    ...
    <center>
        <input type="button" onclick="window.location.href='fkAddSchedule.php';" value="Add Schedule" /> <input type="button" onclick="window.location.href='fkSchedule.php';" value="Update Schedule" />
    </center>
