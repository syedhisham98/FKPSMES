...
<div class="sl-mainpanel">
 ...
 <h2>Intellectual Property Information</h2>
 <div class="col-sm-6 col-md-1 mg-t-0 mg-md-t-0">
              <a href="<?php echo e(route('lecturer.intellectual.add')); ?>" style="float: right;" class="btn btn-rounded btn-info mg-r-5"> Add Intellectual<br> Property</a>
</div>
            ...
            <div id="datatable2_wrapper" class="dataTables_wrapper no-footer">
              ...
              <thead>
                <tr role="row">
                    ...
                    <th class="wd-15p sorting" tabindex="0" aria-controls="datatable2" rowspan="1" colspan="1"  aria-label="Code: activate to sort column ascending">Name</th>
              ...
              <tbody>
              <?php $__currentLoopData = $allData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $intel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr role="row" class="odd">
                  <td tabindex="0" class="sorting_1"><?php echo e($key+1); ?></td>
                  <td><?php echo e($intel->name); ?></td>
                  <td><a href="<?php echo e(route('lecturer.intellectual.delete',$intel->id)); ?>" class="btn btn-danger" id="delete">Delete</a></td>
                </tr>
...
<?php echo $__env->make('lecturer.lect_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\UMP\Degree\SEM6\SOFTWARE ENGINEERING PRACTICE\Laravel_PSM\resources\views/lecturer/expertise/intellect_view.blade.php ENDPATH**/ ?>