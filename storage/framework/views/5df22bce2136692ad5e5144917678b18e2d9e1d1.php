...
<div class="sl-mainpanel">
 ...
 <div class="col-sm-6 col-md-1 mg-t-0 mg-md-t-0">
              <a href="<?php echo e(route('lecturer.research.add')); ?>" style="float: right" class="btn btn-rounded btn-info mg-r-5"> Add Research</a>
</div>
        ...
        <div class="table-wrapper" style="padding-top:2%;"><!--start table Reseerch-->
            <div id="datatable2_wrapper" class="dataTables_wrapper no-footer">
              ...
              <tbody>
              <?php $__currentLoopData = $allData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $research): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr role="row" class="odd">
                  <td tabindex="0" class="sorting_1"><?php echo e($key+1); ?></td>
                  <td><?php echo e($research->title); ?></td>
                  <td><?php echo e($research->role); ?></td>
                  <td><a href="<?php echo e(route('lecturer.research.delete',$research->id)); ?>" class="btn btn-danger" id="delete">Delete</a></td>
                </tr>
...
<?php echo $__env->make('lecturer.lect_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\UMP\Degree\SEM6\SOFTWARE ENGINEERING PRACTICE\Laravel_PSM\resources\views/lecturer/expertise/research_view.blade.php ENDPATH**/ ?>