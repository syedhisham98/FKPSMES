            ...
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</a>
                    <?php else: ?>
...
<?php /**PATH C:\Users\Admin\Documents\GitHub\Laravel_PSM\resources\views/welcome.blade.php ENDPATH**/ ?>