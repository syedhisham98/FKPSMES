...
<div class="sl-header">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                <li><a href="<?php echo e(route('lecturer.profile.view')); ?>"><i class="icon ion-ios-person-outline"></i> Edit Profile</a></li>
    ...
    </div><?php /**PATH D:\UMP\Degree\SEM6\SOFTWARE ENGINEERING PRACTICE\Laravel_PSM\resources\views/lecturer/body/header.blade.php ENDPATH**/ ?>