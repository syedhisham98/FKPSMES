...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <?php echo $__env->make('technician.body.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- sl-sideleft -->
    <!-- ########## END: LEFT PANEL ########## -->

    <!-- ########## START: HEAD PANEL ########## -->
    <?php echo $__env->make('technician.body.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- sl-header -->
    <!-- ########## END: HEAD PANEL ########## -->
...
<?php echo $__env->yieldContent('technician'); ?>
    <!-- sl-mainpanel -->
    <!-- ########## END: MAIN PANEL ########## -->
...
<?php /**PATH C:\Users\HP\Documents\GitHub\Laravel_PSM\resources\views/technician/tech_master.blade.php ENDPATH**/ ?>