 ...
 <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
      ...
      <div class="pd-10 bg-gray-300 mg-t-20">
              ...
              <div class="form-layout-footer mg-t-30">
                <button class="btn btn-info mg-r-5"><a href="<?php echo e(route('lecturer.profile.edit')); ?>">Edit Profile</button>
...
<?php echo $__env->make('lecturer.lect_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\UMP\Degree\SEM6\SOFTWARE ENGINEERING PRACTICE\Laravel_PSM\resources\views/lecturer/profile/profile_view.blade.php ENDPATH**/ ?>