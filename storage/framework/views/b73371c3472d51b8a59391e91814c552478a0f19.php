...
<div class="sl-header">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                <li><a href="<?php echo e(route('technician.profile.view')); ?>"><i class="icon ion-ios-person-outline"></i> Edit Profile</a></li>
    ...
    </div><?php /**PATH C:\Users\HP\Documents\GitHub\Laravel_PSM\resources\views/technician/body/header.blade.php ENDPATH**/ ?>